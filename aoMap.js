...
const sphereRoughnessMap = textureLoader.load(
  "./texture/Metal_006_roughness.jpg"
);
const sphereNormalMap = textureLoader.load("./texture/Metal_006_normal.jpg");
const spheremetalnessMap = textureLoader.load(
  "./texture/Metal_006_metallic.jpg"
);
const sphereAoMap = textureLoader.load("./texture/Metal_006_ambientOcclusion.jpg");
...
const sphereMat = new THREE.MeshStandardMaterial({
  ...
  metalnessMap: spheremetalnessMap,
...
gui.add(params, "aoMapIntensity", 0, 10, 0.01);
gui.open();
...
function animate() {
  ...
  sphereMesh.material.metalness = params.metalness;
  sphereMesh.material.aoMapIntensity = params.aoMapIntensity;
